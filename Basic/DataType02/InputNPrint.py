...
a,b = input('콤마(,)을 기준으로 두개의 숫자를 입력하세요?').split(",")
print('두 숫자의 합:',int(a)+int(b))
'''
'''
...
#m = map(int,input('두 개의 숫자를 입력?').split())
...
print(a,b,'sep키워드 인수 사용',sep='▲')
print(a,b,'2-1.여러개 동시에 출력하기:sep사용 - 줄바꿈',sep='\n')

...
print('[딕셔너리 생성 다섯번째:dict([(),[],,,,,])생성자 혹은 dict(([],(),,,,))함수 사용]')
...
print(list(z))#요소를 보기위해 리스트로 변환
#d=dict(z)
#print(d)#{}
z=zip(('name','age','addr'),('다길동',30,'청담동'))
d=dict(z)
print(d)#{'name': '다길동', 'age': 30, 'addr': '청담동'}

z=zip(('name',),('다길동',30,'청담동'))#적은 요소를 가진 객체를 기준으로 딕션너리 생성
d=dict(z)
print(d)#{'name': '다길동'}
print('[딕션너리 읽기-딕션너리[키] 혹은 get(키[,기본값])]')

...
print('1.join():리스트(이터러블객체)를 문자열로 변환')
...
b='▲'.join(map(str,a))
pprint(b)
print('2.split(구분자):특정 구분자로 split해서 리스트를 반환(디폴트가 공백)')
c=b.split('▲')
pprint(c)
...
print('10. find()/rfind():문자열찾기(찾은 문자열의 인덱스 반환)')
#찾은 문자열이 없는 경우 -1 반환
print(g.find('He'))
print(g.rfind('He'))
print(g.find('he'))
print('11. index()/rindex():문자열찾기(찾은 문자열의 인덱스 반환)')
#찾는 문자열이 없는 경우 에러
print(g.index('He'))
print(g.rindex('He'))

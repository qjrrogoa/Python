...
print(a[-1])
'''
#rint(a[len(a)])#IndexError: string index out of range
...
# 그대로 문자열로 변경된다 즉 "['B', 'Y', 'T', 'H', 'O', 'N']"
#a=str(a)
#print('value:{},type:{}'.format(a,type(a)))
#4. "".join(리스트)를 사용하거나 아래처럼 리스트의 각 요소를 문자열에 누적하여 변경된 문자열을 만든다
#join()함수 사용
b=''.join(a)
...
for temp in a:
    b+=str(temp)
print('value:{},type:{}'.format(b,type(b)))
#슬라이싱: 인덱스를 사용해서 특정 범위의 요소들을 꺼내올수 있다(시퀀스 객체인 경우)
print('[문자열 slicing]')
d='ABCDEFG'
